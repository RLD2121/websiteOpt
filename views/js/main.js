...
var resizePizzas = function(size) {
    ...
    function changePizzaSizes(size) {
        //Took out of the for loop
        var randomPizza = document.getElementsByClassName("randomPizzaContainer");
        
        //Cached the length
        var pizzaLength = randomPizza.length;
        
        //function determineDx() deleted as it is no longer needed with the
        //addition of the code below.
        //Used switch function to define newWidth
        var newWidth;
        switch (size) {
            case "1":
                newWidth = 25;
